...
import OutletsDetails from '../components/outlets/editoutletdetails';
...
const mapDispatchToProps = dispatch => ({
  ...
  onChangePassword: (id,username,newPass) => {
    return dispatch(actions.onChangePassword(id,username,newPass));
  },
...
const VisibleEditOutletContainer = connect(mapStateToProps, mapDispatchToProps)(EditOutletContainer);

const RouterVisibleEditOutletContainer = withRouter(VisibleEditOutletContainer);

export default RouterVisibleEditOutletContainer;
